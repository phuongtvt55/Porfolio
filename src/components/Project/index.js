...
Most functions are similar to other e-commerce websites such as wishlist, purchasing, search, payment, manage profile, etc. (the admin management will update soon).`
    ...
    useEffect(() => {
            ...
            gsap.to(slideNextImg, {
                ...
                onComplete: () => {
                    ...
                    if (nextSlide) {
                        ...
                        if (nextSlideImg) nextSlideImg.classList.remove("slider-next-img");
                    }
                    setTimeout(() => {
                        isAnimating = false;
                    }, 1500);
        ...
        return () => {
            ...
            gsap.killTweensOf(".slider-content-active h1 span, .slider-content-active p, .slider-active img, .slider-content-next h1 span, .slider-content-next p, .slider-content-next, .slider .slider-next:last-child .slider-next-img, .slider-next-img");
        };
    }, [sliderContent, sliderDescriptions]);
